CREATE DATABASE  IF NOT EXISTS `gasvalid` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_spanish2_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `gasvalid`;
...
CREATE TABLE `tabla_datos_dictamen` (
  ...
  `lado_dispensario` varchar(10) COLLATE utf8_spanish2_ci DEFAULT NULL,
...
-- Dump completed on 2021-05-07 20:05:01
